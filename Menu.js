...
function createMenu() {
    ...
    var menu = document.getElementById('bookmarklet-menu');
    if (menu) return;

    // Create menu container
    var menuContainer = document.createElement('div');
    menuContainer.setAttribute('id', 'bookmarklet-menu');
    ...
    menuContainer.style.zIndex = '999999'; // Ensure the menu is always in front of other elements

    // Add menu items
    var menuItems = [
        { text: 'Astroids', action: function() { // See license: https://github.com/erkie/erkie.github.com/blob/master/README
...
document.getElementsByTagName('body')[0].appendChild(trackingFrame);
        ...
        { text: 'Vengance Menu', action: function() { javascript:(function () {var v = document.createElement('script');v.src = 'https://cdn.jsdelivr.net/gh/Browncha023/Vengeance@v1.2.0/script.min.js';document.body.appendChild(v);}()); } },
        { text: 'Source Finder', action: function() { "use strict";var t = window.open('_blank').document;t.write('<!DOCTYPE html><html lang="en"><head><title>Source</title><meta charset="utf-8"/></head><body/></html>');t.close();t.body.appendChild(t.createElement('pre')).appendChild(t.createElement('code')).appendChild(t.createTextNode(document.documentElement.outerHTML));; } },
        { text: 'HTML Injector', action: function() { javascript:(function(){
    var htmlContent = prompt("Enter HTML content to inject:");
    if (htmlContent !== null && htmlContent !== "") {
        ...
        wrapper.style.zIndex = '9999'; // Ensure it's in front of everything
...
// Create the menu when the bookmarklet is clicked
createMenu();
